    ...
    init: function init() {
      ...
      function display() {
        ...
        function animation() {
          ...
          tl.from('#txt-1,#txt-2,#txt-3,#txt-4,#txt-5,#txt-6,#txt-7,#txt-8,#txt-9,#txt-10,#txt-11,#safer-lockup,#cta', 0.4, {
            stagger: 0.2,
            autoAlpha: 0,
            y: 10
        ...
        // function animeLogo() {
        //   const _spriteW = 120;
        //   const _spriteFrames = 63;
        //   const _totalPosition = `-${_spriteW * _spriteFrames}px 0`;
        //   const tl = gsap.timeline();
        //   tl.to('.logo-animation', { duration: 2, backgroundPosition: _totalPosition, ease: `steps( ${_spriteFrames})` });
        //   return tl;
        // }
